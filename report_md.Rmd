...
**Apendix A** shows an alternative method for simulating background TV. Although the method shown there has mean values that are closer to the original article, it does not take into account the fact that infants who are exposed to more touchscreens are also likely exposed to more TV. 
# Data Exploration
...
## Appendix A: Alternative TV simulation
